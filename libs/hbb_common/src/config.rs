...
pub const RENDEZVOUS_SERVERS: &[&str] = &["222.92.142.228"];
pub const RS_PUB_KEY: &str = "PNE5W8NKIBNX3tCpkv0LGI88kidG6KW0XrHUPRQOh5Y=";

pub const RENDEZVOUS_PORT: i32 = 60006;
pub const RELAY_PORT: i32 = 60007;
